  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn("absolute inset-y-0 z-20 w-4", className)}
        {...props}
      />
    );
  }
...
const SidebarInput = React.forwardRef((props, ref) => (
  <Input
    ref={ref}
    className={cn("h-8 w-full bg-background", props.className)}
    {...props}
  />
));
...
const SidebarHeader = React.forwardRef((props, ref) => (
  <div ref={ref} className={cn("flex flex-col gap-2 p-2", props.className)} {...props} />
));
...
const SidebarSeparator = React.forwardRef((props, ref) => (
  <Separator ref={ref} className={cn("mx-2", props.className)} {...props} />
));
...
const SidebarGroup = React.forwardRef((props, ref) => (
  <div ref={ref} className={cn("flex flex-col p-2", props.className)} {...props} />
));
...
// (rest of components continue same pattern...)
